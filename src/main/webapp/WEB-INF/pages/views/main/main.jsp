		...
		<div class="area">
			...
			<div class="portfolio-area">
				<div class="portfolio" id="portfolio">
                    <div class="portfolio-info info1">
                        <div class="info-img clear_fix">
                            ...
                            <div>
                                <img src="${contextPath}/resources/img/portfolio/portfolio-01.png" alt=""/>
                                <div class="txt-view">
                                    <ul>
                                    </ul>
                                </div>
                    ...
                    <div class="portfolio-info info2">
                        <div class="info-img clear_fix">
                            <div style="background:none;border:0px"></div>
                            <div>
                                <img src="${contextPath}/resources/img/portfolio/portfolio-02.png" alt=""/>
                    ...
                    <div class="portfolio-info info4">
                        <div class="info-img clear_fix">
                            <div style="background:none;border:0px"></div>
                            <div>
                                <img src="${contextPath}/resources/img/portfolio/portfolio-04.png" alt=""/>
                    ...
                    <div class="portfolio-info info6">
                        <div class="info-img clear_fix">
                            <div>
                                ...
                                <img src="${contextPath}/resources/img/portfolio/portfolio-06-1txt.jpg" alt=""/>
                            </div>
                            <div class="bg-board">
				...
				<div class="thumb-area">
					<ul>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-01.png" alt=""/></a></li>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-02.png" alt=""/></a></li>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-03.png" alt=""/></a></li>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-04.png" alt=""/></a></li>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-05.png" alt=""/></a></li>
						<li><a href=""><img src="${contextPath}/resources/img/portfolio/portfolio-thumb-06.png" alt=""/></a></li>
					</ul>
				</div>
			</div>
		</div>
...
<script>
    ...
    $(function(){ //병원이미지슬라이드
        var timerID, delay=1500;
        timerID = setInterval(play, delay);
        function play(){
            var first=$("#slide-img .slide-banner img").first();
            $("#slide-img .slide-banner").animate({left:"-640"},700,
                    function(){
                        $("#slide-img .slide-banner").css("left","-320px").append(first);
                    });
        }
    });
    ...
    $(function(){ //카페이미지슬라이드
        var timerID, delay=1500;
        timerID = setInterval(play, delay);
        timerID = setInterval(play2, delay);
        function play(){
            var first=$("#slide .img-list li").first();
            $("#slide .img-list").animate({left:"-310"},600,
                    function(){
                        $("#slide .img-list").css("left","-155px").append(first);
                    });
        }
        function play2(){
            var first=$("#slide2 .img-list li").first();
            $("#slide2 .img-list").animate({top:"0"},600,
                    function(){
                        $("#slide2 .img-list").css("top","-192px").append(first);
                    });
        }
    });
    <!-- 개발계 추가 -->
